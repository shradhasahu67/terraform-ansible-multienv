...
# Paths and Variables
TERRAFORM_OUTPUT_DIR="/c/Users/ASUS/terraform/terraform"  # Replace with the actual Terraform directory path
ANSIBLE_INVENTORY_DIR="/c/Users/ASUS/terraform/ansible/inventories"
...
update_inventory_file() {
    ...
    echo "ansible_ssh_private_key_file=/c/Users/ASUS/terraform/terraform/tf-key-ec2" >> "$inventory_file"
